...
.Lloop_start:
	...
	# For each element in the YMM0-2 vectors, calculate L+H, W+H, and L+H into
	# YMM13-15.
	...
	# storing it in YMM13, and then accumulate YMM13 into YMM3.
	vpminud ymm13, ymm13, ymm14
	vpminud ymm13, ymm13, ymm15
	vpmulld ymm13, ymm13, ymm12
	vpaddd ymm3, ymm3, ymm13

	# Multiply the values of YMM0-2 with each other, and then accumulate the
	# result into YMM3.
	vpmulld ymm13, ymm0, ymm1
	vpmulld ymm13, ymm13, ymm2
	vpaddd ymm3, ymm3, ymm13
